...
class DateItem extends PureComponent {
    render() {
        ...
        const highlightBgColor = 'rgba(188,205,154,0.64)';
        const normalBgColor = 'white';
        const hightlightTextColor = '#fff';
        const normalTextColor = 'rgba(65,74,56,0.9)';
        return (
                ...
                >
                    <View style={[
                        ...
                        <View style={[
                            ...
                            {backgroundColor: highlight ? 'white' : 'rgba(188,205,154,0.64)'}
                        ]} />
                        }
                    </View>
                </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    headerDateWeek: {
        color: 'rgba(188,205,154,0.64)',
        fontSize: 14,
    },
    headerGoTodayButton: {
        borderRadius: 10,
        width: 20, height: 20,
        backgroundColor: 'rgba(188,205,154,0.64)',
